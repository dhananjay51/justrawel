...
class BackpackItem extends StatelessWidget {
  final BestPackingData dataItem;
  const BackpackItem({
    super.key,
    ...
    return SingleChildScrollView (
      ...
      Container(
         height: 25,
          ...
          child: Padding(padding: EdgeInsets.all(5), child:  Text("Easy to Mordrate", style: AppStyle.instance.bodyMedium.copyWith(
            color: AppColors.blackColor,
          )))),
      ...
      Padding(
       ...
       if (dataItem.defaultPrice?.discountedPrice != null)
         ...
         Padding(
          ...
          child: Text(
            '\u{20B9} ${dataItem.defaultPrice!.price.toString()}',
            style: AppStyle.instance.bodySemi.copyWith(
  ...
  Container _bestSellerPoster(double height, double width) {
    String  urlPath  =    Imagepath.categorgridPath.description + dataItem.image![5].image!;
    return Container(
