...
class _PackageInfoState extends State<PackageInfoDetail> {
  ...
  Widget _itinearyListControl() => ListTile(
    ...
    title: Text('Delhi to Manali | Overnight Journey',style: AppStyle.instance.bodySemi.copyWith(
      color: AppColors.blackColor,
    )),
  ...
  children: [
  Text(
  "Start Point : Delhi", style: AppStyle.instance.bodySemi.copyWith(
  color: AppColors.blackColor,
  )),
  SizedBox(height: 5,),
  Text(
  ...
  children: [
  Text(
  "End Point : Delhi", style: AppStyle.instance.bodySemi.copyWith(
  color: AppColors.blackColor,
  )),
  SizedBox(height: 5,),
  Text(
  ...
  child: Text(
  maxLines: 5,
  "Transportation in Tempo Traveller from Manali to Manali", style: AppStyle.instance.bodySemi.copyWith(
  color: AppColors.blackColor,
  )),
  ),
  ],
